    ...
    event.respondWith((async () => {
      try {
        ...
        return new Response(
          ...
          '<body style="font-family:Segoe UI,Arial,sans-serif;background:#F4F1F9;color:#463C8F;padding:40px;text-align:center">' +
          '<h2>Not available offline</h2><p>This page was not part of the offline download.</p>' +
          '<p><a href="/index.html" style="color:#CE0C88;font-weight:700">Back to the portal</a></p></body>',
